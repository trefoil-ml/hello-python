Hello Python! Source code.

This is the source code for Hello Python!, written by Anthony Briggs, and
available from http://manning.com/briggs/. It's released under the BSD license,
so that you're free to extend and adapt it for anything that you like, provided
that you attribute it correctly.
